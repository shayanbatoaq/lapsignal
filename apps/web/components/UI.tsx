import { AlertTriangle, ArrowUpRight, Check, Database, Info, type LucideIcon } from "lucide-react";
...
export function DemoBanner() {
  return (
    <div className="demo-banner" role="status">
      ...
      <div><strong>Demo data</strong><span>Seeded telemetry · fixed random seed · no live connection required</span></div>
      <Link href="/app/live">Open replay <ArrowUpRight size={14} /></Link>
    </div>
  );
}
